import { isForbiddenPropKey, LIMITS, looksLikeEmail, } from './envelope.js';
/**
...
export function deviceFromUserAgent(ua) {
    ...
    if (/ipad|tablet|playbook|silk/.test(s))
        return 'tablet';
    if (/mobi|iphone|android.*mobile|phone/.test(s))
        return 'mobile';
    return 'desktop';
}
 ...
 */
export function normaliseEvent(payload, allowedEvents) {
    ...
    const consentRaw = (typeof raw.consent === 'object' && raw.consent !== null ? raw.consent : {});
    const consent = {
 ...
 */
export function mayForward(event) {
